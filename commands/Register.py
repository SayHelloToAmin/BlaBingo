...
CMD | /help""")
        ...
        if str(message.chat.type) == "ChatType.SUPERGROUP":
            ...
            await message.reply("""✅ | این گروه با موفقیت ثبت شد و من از همین الان درحال یادگیری نحوه حرف زدن تو 
            گروهتونم . . . 🤡 | درواقع من هر لحظه درحال یادگیری هستم و گاهی کلماتی که قبلا شما گفتین رو با هم ترکیب 
            میکنم و میگم ( بعضی وقتا جمله های جالبی میسازم 👐🏿 ) 
